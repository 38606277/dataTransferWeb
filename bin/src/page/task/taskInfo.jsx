              ...
              <Col span={12}> 
                  <FormItem {...formItemLayout} label='类路径'>
                        {getFieldDecorator('jobClassPath', {
                          rules: [{ required: true, message: '请输入类路径!', whitespace: true }],
                        })(
                          <Input  type='text' name='jobClassPath'  />
                        )}
                      </FormItem>
              </Col>
          </Row>
